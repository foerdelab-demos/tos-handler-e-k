...
<header class="site-header" role="banner">
  <div class="site-header__inner container">
    ...
    <div class="site-header__actions">
      <a href="tel:<?php echo CONTACT_PHONE_TEL; ?>" class="site-header__tel" aria-label="Buero anrufen: <?php echo CONTACT_PHONE; ?>">
    ...
    <button class="nav-burger" aria-expanded="false" aria-controls="mobile-nav" aria-label="Navigation oeffnen">
...
<div id="mobile-nav" class="mobile-nav" aria-hidden="true" role="dialog" aria-modal="true" aria-label="Mobile Navigation">
  <div class="mobile-nav__inner">
    <button class="mobile-nav__close" aria-label="Navigation schliessen">
